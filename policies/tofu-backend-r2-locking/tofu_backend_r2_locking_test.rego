...
test_dynamodb_table_instead_of_lockfile_reports_both if {
	...
	contains(m, "must set use_lockfile = true")
	some n in msgs
	contains(n, "must not set dynamodb_table")
}
